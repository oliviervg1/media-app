...
<script type="text/javascript">
	function addVideo() {
		var video = 'webMethod/addTrack?p=' + getTitle() + '&p=' + getUrl() + '&p=' + getType();
	...
	<div id="addVideo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
		...
		<div class="modal-body">   
			...
			<div class="tab-pane fade" id="upload">
			   	<form:form class="form-horizontal" modelAttribute="uploadItem" action="uploadFile" method="post" enctype="multipart/form-data">
				    <fieldset>
				...
				<table class="table table-hover">
					<thead>
				  	...
				  	<tbody>
				    	...
				    	<tr>
				    		<td>${loop.index}</td>
							<td><a href="webMethod/removeTrack?p=${track}">${track}</a></td>
						</tr>
						</c:forEach>
				  	</tbody>
				</table>
